<div id="wrapper" class="acc center fm-create leases index">
    ...
    <div class="hero col-xs-12 center">
            <div class="hr_mn acc_txt hr_txt center">
                <h1 class="main">Add an <span>Attorney</span></h1>
            </div>
        ...
        <div class="content col-xs-8 center">
            ...
            <div class="actions btn-blue col-xs-2 center input left">
                <?php echo $this->Html->link(String::insert(__('List :param1', true), array('param1' => __('Attorneys', true))), array('action' => 'index')); ?>
            </div>

            <div class="attorneys form inline col-xs-12 left push-t">
                
                <?php
                echo $this->Form->create('Attorney', array('type' => 'file', 'action' => 'add'));
