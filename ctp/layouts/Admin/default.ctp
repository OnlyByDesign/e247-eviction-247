...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	...
	<body>
        ...
        <header class="center">
            ...
            <div id="navbar">
                <?php echo $this->element('navigation', array('logged_in' => $logged_in, 'home_link' => $home_link)); ?>
            </div>
            
            <div class="col-xs-12 hd_t center">
                ...
                <div id="desktop" class="hd hd_nav col-xs-6 inline center">
                    ...
                    <div class="mn_wrp">
                        <p><?php if ($logged_in == 1) {echo $this->Html->link('Account', array('controller' => 'users', 'action' => 'dashboard')); }
                        ?></p>
                    ...
                    <div id="navBarAdmin" class="mn_wrp">
                    ...
                    <div id="accOpen" class="hd col-xs-3 inline">
                        <a href="<?php echo $this->Html->url(array('controller' => 'users', 'action' => 'my_account')); ?>">
                            <div class="hd_acc acc_open center">
                                <?php printf("<p>Hello, %s</p>", $this->Session->read('Auth.User.username')); ?>
                            </div>
                        </a>
        ...
        <div class="wrapper" class="admin-user center">
