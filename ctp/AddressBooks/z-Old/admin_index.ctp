...
<div class="left">
	<h2>Address Book for <?php echo $user_name; ?></h2>
</div>
...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(String::insert(__('Add a New :action', true), array('action' => __('Contact', true))), array('action' => 'add', $user_id)); ?></li>
		<li><?php echo $this->Html->link('Back to User Profile', array('controller' => 'users', 'action' => 'view', $user_id)); ?></li>
	</ul>
</div>
