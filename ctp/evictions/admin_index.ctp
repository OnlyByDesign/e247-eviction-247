		...
		$('.update_status').on('click', function() {
			...
			$.ajax({
		        ...
		        $('#EvictionId').val(eviction_id);
						...
						$('#divUpdateStatus, .popups').css({'width' : dialog_width, 'height' : dialog_height});
...
<div id="wrapper" class="acc center fm-create notices index">
        ...
        <div class="hero col-xs-12 center">
            <div class="hr_mn acc_txt hr_txt center">
                <h1 class="main">Evictions - <span><?php echo $title;?></span></h1>
            </div>
        ...
        <div class="content col-xs-12 center">
            ...
            <div class="info col-xs-12 center">
                <div id="list" class="info_wrap lrg center">
                    <?php echo $this->element('evictions_list_admin'); ?>
                </div>
            </div>
...
<div class="popups">
    <?php include '/app/webroot/files/update_status_popup.inc'; ?>
<div id="divPopup">
