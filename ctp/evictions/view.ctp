...
<div id="wrapper" class="acc center fm-lease">
    ...
    <div class="hero col-xs-12 center">
        <div class="hr_mn acc_txt hr_txt center">
                <h1 class="main">eviction <span>complete</span></h1>
            </div>
    ...
    <div class="content center col-xs-9">
        ...
        <div class="evictions view">
            ...
            <!--dt><?php echo __('Last modification date'); ?></dt>
            <dd>
                <?php echo date('l, F jS Y', strtotime($eviction['Eviction']['modified'])); ?>
                &nbsp;
            </dd-->
            ...
            <fieldset>
                ...
                <?php
                    if ($in_settlement == 1) echo '<div id="divStampPending">' . $this->Html->image('/img/stamp_pending.png', array('class' => 'stampPending')) . '</div>';
                    if ($is_contested == 1) echo '<div id="divStampContest">' . $this->Html->image('/img/stamp_contest.png', array('class' => 'stampContest')) . '</div>';
            ...
            <fieldset>
                ...
                <dt><?php echo __('Section 8 Subsidized Rent'); ?></dt>
                <dd>
                    <?php echo ($eviction['Eviction']['is_subsidized_rent'] == 0 ? 'No' : 'Yes'); ?>
                    &nbsp;
                </dd>
            ...
            <fieldset>
                ...
                <h3 class="secondh3">Client Charges</h3>
                ...
                <div id="divClientFees">
                    ...
                    if ($eviction['Payment']['cost_posting_fee'] > 0) echo '<div class="left feesDetails">&nbsp;&nbsp; Posting of Notice to Pay:</div>			<div class="left feesDetailsAmount"><div class="left">$</div><div class="right">' . number_format($eviction['Payment']['cost_posting_fee'], 2) . '</div></div><br class="clear" />';
                      ...
                      echo '<div class="left feesDetails"><strong>Additional Client Charges:</strong></div> 														<div class="left"></div><br class="clear" />';
                        if ($eviction['Eviction']['notice_to_pay_1']) echo '<div id="divNoticeToPay1"><div class="left feesDetails">&nbsp;&nbsp; Notice Posted (1):&nbsp;</div>								<div class="left feesDetailsAmount"><div class="left">$</div><div class="right">' . number_format($extra_fees['ExtraFee']['notice_to_pay_1'], 2) . 		'</div></div><br class="clear" /></div>';
                        if ($eviction['Eviction']['notice_to_pay_2']) echo '<div id="divNoticeToPay2"><div class="left feesDetails">&nbsp;&nbsp; Notice Posted (2):&nbsp;</div>								<div class="left feesDetailsAmount"><div class="left">$</div><div class="right">' . number_format($extra_fees['ExtraFee']['notice_to_pay_2'], 2) . 		'</div></div><br class="clear" /></div>';
                        if ($eviction['Eviction']['notice_to_pay_3']) echo '<div id="divNoticeToPay3"><div class="left feesDetails">&nbsp;&nbsp; Notice Posted (3):&nbsp;</div>								<div class="left feesDetailsAmount"><div class="left">$</div><div class="right">' . number_format($extra_fees['ExtraFee']['notice_to_pay_3'], 2) . 		'</div></div><br class="clear" /></div>';
                        if ($eviction['Eviction']['court_appearance_1']) echo '<div id="divCourtAppearance1"><div class="left feesDetails">&nbsp;&nbsp; Court Appearance (1):&nbsp;</div>				<div class="left feesDetailsAmount"><div class="left">$</div><div class="right">' . number_format($extra_fees['ExtraFee']['court_appearance_1'], 2) . '</div></div><br class="clear" /></div>';
                        if ($eviction['Eviction']['court_appearance_2']) echo '<div id="divCourtAppearance2"><div class="left feesDetails">&nbsp;&nbsp; Court Appearance (2):&nbsp;</div>				<div class="left feesDetailsAmount"><div class="left">$</div><div class="right">' . number_format($extra_fees['ExtraFee']['court_appearance_2'], 2) . '</div></div><br class="clear" /></div>';
                        if ($eviction['Eviction']['court_appearance_3']) echo '<div id="divCourtAppearance3"><div class="left feesDetails">&nbsp;&nbsp; Court Appearance (3):&nbsp;</div>				<div class="left feesDetailsAmount"><div class="left">$</div><div class="right">' . number_format($extra_fees['ExtraFee']['court_appearance_3'], 2) . '</div></div><br class="clear" /></div>';
                        if ($eviction['Eviction']['case_settlement']) echo '<div id="divCaseSettlement">	<div class="left feesDetails">&nbsp;&nbsp; Case Settlement: </div>							<div class="left feesDetailsAmount"><div class="left">$</div><div class="right">' . number_format($extra_fees['ExtraFee']['case_settlement'], 2) . 		'</div></div><br class="clear" /></div>';
                        if ($eviction['Eviction']['judicial_default']) echo '<div id="divJudicialDefault">	<div class="left feesDetails">&nbsp;&nbsp; Judicial Default: </div>							<div class="left feesDetailsAmount"><div class="left">$</div><div class="right">' . number_format($extra_fees['ExtraFee']['judicial_default'], 2) . 		'</div></div><br class="clear" /></div>';
                    ?>
                </div>
