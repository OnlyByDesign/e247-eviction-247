<div id="wrapper" class="acc center fm-create">
    ...
    <div class="content col-xs-10 center">
        ...
        <div class="actions col-xs-12 inline">
            ...
            <p class="left inline push-l input center"><strong><?php echo $this->Html->link('Back to User Profile', array('controller' => 'users', 'action' => 'view', $user_id)); ?></strong></p>
        </div>

        <div class="entry index col-xs-12 left flex push-t push-b">
