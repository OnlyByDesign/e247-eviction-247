<div id="wrapper" class="acc center fm-create">
    ...
    <div class="hero col-xs-12 center">
        <div class="hr_mn acc_txt hr_txt center">
            <h1 class="main">Tenant <span>Noticies</span></h1>
        </div>
    ...
    <div class="content col-xs-10 center">
        ...
        <div class="tenants index col-xs-12 left flex push-t push-b">
            ...
            <table cellpadding="0" cellspacing="0">
                ...
                <tr<?php echo $class;?>>
                    ...
                    <td class="actions">
                    <?php
                        echo $this->Html->link('Delete', array('action' => 'delete', $lease_id, $tenant['Tenant']['id']), null, String::insert(__('Are you sure you want to delete :param1 :param2?', true), array('param1' => $tenant['Tenant']['first_name'], 'param2' => $tenant['Tenant']['last_name']))
                        );
                    ?>
                    </td>
                </tr>
        ...
        <div class="btn-blue col-xs-3 center left">
            <?php echo $this->Html->link($this->Html->image('Continue'), array('controller' => 'leases', 'action' => 'edit', $lease_id), array('escape' => false));
        } ?>
