<div id="wrapper" class="acc center fm-create">
    ...
    <div class="hero col-xs-12 center">
        <div class="hr_mn acc_txt hr_txt center">
            <h1 class="main"><span>view</span> tenant notices</h1>
        </div>
    ...
    <div class="content col-xs-10 center">
        ...
        <div class="actions col-xs-12 inline">
            ...
            <p class="left inline push-l center"><strong><?php echo $this->Html->link(sprintf(__('Delete %s', true), __('Defendant', true)), array('action' => 'delete', $defendant['Defendant']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $defendant['Defendant']['id'])); ?></strong></p>
            <p class="left inline push-l center"><strong><?php echo $this->Html->link(sprintf(__('List %s', true), __('Defendants', true)), array('action' => 'index')); ?></strong></p>
            <p class="left inline push-l center"><strong><?php echo $this->Html->link(sprintf(__('New %s', true), __('Defendant', true)), array('action' => 'add')); ?></strong></p>
            <p class="left inline push-l center"><strong><?php echo $this->Html->link(sprintf(__('List %s', true), __('Evictions', true)), array('controller' => 'evictions', 'action' => 'index')); ?></strong></p>
            <p class="left inline push-l center"><strong><?php echo $this->Html->link(sprintf(__('New %s', true), __('Eviction', true)), array('controller' => 'evictions', 'action' => 'add')); ?></strong></p>
        </div>
