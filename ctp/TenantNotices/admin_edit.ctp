...
<div id="wrapper" class="acc center fm-create">
    ...
    <div class="hero col-xs-12 center">
        <div class="hr_mn acc_txt hr_txt center">
            <h1 class="main"><span>edit</span> tenant notice</h1>
        </div>
    ...
    <div class="content col-xs-10 center">
        ...
        <div class="actions col-xs-12 inline">
            <div class="btn-blue col-xs-2 center left">
                <?php echo $this->Html->link(String::insert(__('List :param1', true), array('param1' => __('Tenants', true))), array('action' => 'index', $notice_id)); ?>
            </div>
        ...
        <div class="tenant_notices form col-xs-12 left flex push-t push-b">
            
            <?php echo $this->Form->create('TenantNotice');?>
