...
<div id="wrapper" class="acc center fm-lease">
    ...
    <div class="content col-xs-10 center">
        ...
        <div class="info col-xs-12 center clearfix leases form">
				...
				<?php
					echo $this->Form->create('Lease', array('novalidate' => true));
                ...
                <div id="fm2" class="tab fld col-xs-10 center">
                    <div class="info_wrap lrg col-xs-12 center left">
                        ...
                        <p class="main">Tenants are persons that will reside at the property and are signing the lease.</p>
                        <?php
                            if ($lease_renewal == 1) {
                                echo $this->element('tenants');
                            echo '<a href="#" id="addTenant">Add A Tenant</a>';
                            } else {
                        ?>
                        <div id="table-tenants" class="flex">
                            <?php
                                if (!empty($tenants)) {
                                    $i = 0;
                                    for ($i=0; $i<$tenants_number; $i++) {
                                        echo '<tr>';
                                            ...
                                            echo '<td>' . $this->Form->input('Tenant.' . $i . '.first_name', [
                                            ...
                                            echo '<td>' . $this->Form->input('Tenant.' . $i . '.middle_name', [
                                                'div' => array('class' => 'fm_input fm_text col-xs-3-2 center inline left'),
                                                'class' => 'input col-xs-12 center',
                                                'type' => 'text',
                                            ...
                                            echo '<td>' . $this->Form->input('Tenant.' . $i . '.last_name', [
                    ...
                    <div class="info_wrap lrg col-xs-12 center left">
                                ...
                                $i = 0;
                                  foreach ($owners as $owner) {
                                        echo '<tr>';
                                            ...
                                            echo '<td>' . $this->Form->input('Owner.' . $i . '.first_name', [
                                            ...
                                            echo '<td>' . $this->Form->input('Owner.' . $i . '.middle_name', [
                                                'div' => array('class' => 'fm_input fm_text col-xs-2-2 inline center left'),
                                                'class' => 'input col-xs-12 center',
                                                'required' => false,
                                                'type' => 'text',
                                            ...
                                            echo '<td>' . $this->Form->input('Owner.' . $i . '.last_name', [
                                                'div' => array('class' => 'fm_input fm_text col-xs-2-2 inline center left'),
                                                'class' => 'input col-xs-12 center',
                                                'required' => false,
                                                'type' => 'text',
                                            ...
                                            echo $this->Form->input('Owner.' . $i . '.company_name', [
                                ...
                                for ($i=0; $i<$owners_number; $i++) {
                                    echo '<tr>';
                                        ...
                                        echo '<td>' . $this->Form->input('Owner.' . $i . '.first_name', [
                                            ...
                                            'after' =>  'Manager first name',
                                            'required' => false,
                                            'value' => $autofill_owner[$i]['first_name'],
                                            'label' => false
                                        ]) . '</td>';                                    
                                        echo '<td>' . $this->Form->input('Owner.' . $i . '.middle_name', [
                                            'div' => array('class' => 'fm_input fm_text col-xs-2-2 inline center left'),
                                            ...
                                            'after' =>  'Manager first name',
                                            'required' => false,
                                            'value' => $autofill_owner[$i]['middle_name'],
                                            'label' => false
                                        ]) . '</td>';                                    
                                        echo '<td>' . $this->Form->input('Owner.' . $i . '.last_name', [
                                            'div' => array('class' => 'fm_input fm_text col-xs-2-2 inline center left'),
                                            ...
                                            'after' =>  'Manager first name',
                                            'required' => false,
                                            'value' => $autofill_owner[$i]['last_name'],
                                            'label' => false
                                        ]) . '</td>';
                                    
                                        echo '<td>' . $this->Form->input('Owner.' . $i . '.company_name', [
                                            'div' => array('class' => 'fm_input fm_text col-xs-2-2 inline center left last'),
                                            'class' => 'input col-xs-10 right company-field',
                                            'before' => '<span class="left">OR</span>',
                                            'type' => 'text',
                                            ...
                                            'after' =>  'Company name',
                                            'onkeyup' => 'isCompany(' . $i . ');',
                                            'value' => $autofill_owner[$i]['company_name'],
                                            'required' => false,
                                            'label' => false
                                        ]) . '</td>';
                                    echo '</tr>';
                        ...
                        <?php }
                            if ($lease_renewal != 1) echo $this->Form->input('autofill_owner', array(
                                'div' => array('class' => 'fm_mem col-xs-12 center right'),
                                'class' => 'fm_check',
                                'label' => 'Remember this information',
                                'type' => 'checkbox',
                                'checked' => $autofill_owner[0]['autofill_owner']
                            ));
                        ?>
                        </div>
                    </div>
                    <div class="info_wrap lrg col-xs-12 center left">
                        ...
                        <div class="list-items col-xs-12 center">
                            <?php
                                echo $this->data['Lease']['property_street_address1'];
                                ...
                                echo $this->data['Lease']['property_street_address2'];
                                ...
                                echo $this->data['Lease']['property_city'];
                                ...
                                echo $this->data['Lease']['property_zip_code'];
                                ...
                                echo $this->data['Lease']['property_state'];
                        ...
                        <div class="info_wrap fm_add mid col-xs-8 center inline left">
                            <div id="openPropertyAddressBook" class="if_box col-xs-4 inline center left" onclick="return false;">
                                <i class="if_icon inline inline left far fa-address-book"></i>
                                <p class="inline">Open Address Book</p> 
                            </div>
                            <div id="addToPropertyAddressBook" class="if_box col-xs-4 center inline left" onclick="return false;">
                ...
                <div id="fm3" class="tab fld col-xs-10 center">                    
                    <div class="info_wrap lrg col-xs-12 center inline left">
                        <h2>Person Responsible for Managing the Property</h2>
                        <p class="main">Provide the name and contact information for who will be managing the property. This information will advise the Tenant where to mail rent and how to contact the person managing the property.</p>                        
                        <?php
                            echo '<div class="flex col-xs-12 center">';
                                ...
                                echo $this->Form->input('contact_last_name', [
                                    'div' => array('class' => 'fm_input fm_text col-xs-4 inline left last'),
                                    'class' => 'input col-xs-12 center',
                                    'placeholder' =>  'Last name',
                                    'after' =>  'Last name',
                            ...
                            echo '</div><div class="flex col-xs-12 center">';    
                                echo '<p class="mob col-xs-12 left">Personal address</p>';
                                ...
                                echo $this->Form->input('contact_street_address2', [
                                    'div' => array('class' => 'fm_input fm_text col-xs-1 inline left'),
                                    'class' => 'input col-xs-12 center',
                                    'placeholder' =>  'Unit No.',
                                    'after' =>  'Unit No.',
                                    'value' => $autofill_contact['contact_street_address2'],
                                    'label' => false
                                ]);
                                ...
                                echo $this->Form->input('contact_state', [
                                    'div' => array('class' => 'fm_input col-xs-2 left inline last', 'id' => 'state-field'),
                            ...
                            echo '</div><div class="flex col-xs-12 center">'; 
                                echo $this->Form->input('contact_county_id', [
                                    'div' => array('class' => 'fm_input col-xs-5 inline left', 'id' => 'county-field'),
                                    'class' => 'input col-xs-12 center',
                                    'placeholder' =>  'County',
                                    'after' =>  'County',
                                    'options' => $counties,
                                ...
                                echo $this->Form->input('contact_zip_code', [
                                    'div' => array('class' => 'fm_input fm_text col-xs-2 inline left', 'id' => 'label-zip-code'),
                                    'class' => 'input col-xs-12 center',
                                ...
                                echo $this->Form->input('contact_country', [
                                    'div' => array('class' => 'fm_input fm_text col-xs-3 inline left last', 'id' => 'label-zip-code'),
                                    'class' => 'input col-xs-12 center',
                                    'placeholder' =>  'Country',
                                    'after' =>  'Country',
                                    'required' => true,
                            ...
                            echo '</div><div class="flex col-xs-12 center">';
                                echo '<p class="mob col-xs-12 left">Contact information</p>';
                                ...
                                echo $this->Form->input('contact_phone_number_emergencies', [
                                    'div' => array('class' => 'fm_input fm_text col-xs-3 inline left'),
                                    'class' => 'input col-xs-12 center',
                                    ...
                                    'maxlength' => '10',
                                    'required' => true,
                                    'value' => $autofill_contact['cpne1'],
                                    'label' => false
                                ]);
                                echo $this->Form->error('contact_phone_number', null, array('class' => 'error-message'));
                                echo $this->Form->input('autofill_contact', array(
                                    'div' => array('class' => 'fm_mem col-xs-12 center right'),
                                    'class' => 'fm_check',
                                    'label' => 'Remember this information',
                                    'type' => 'checkbox',
                        ...
                        <div class="flex col-xs-12 center">
                            <?php
                                ...
                                echo $this->Form->input('rent_late_fee_daily', [
                                    ...
                                    ) . '<p class="col-xs-12 left">Additional fees</p>',
                    ...
                    <div class="info_wrap lrg col-xs-12 center inline left">
                        ...
                        <div class="col-xs-12 center inline push-t">
                            <?php                            
                                ...
                                echo '<div class="col-xs-3 fm_input fm_text inline center right last">';
                                    $options = array(
                    ...
                    <div class="info_wrap lrg col-xs-12 center inline left">
                        ...
                        <div class="col-xs-12 center left push-t push-b">
                            <?php
                                ...
                                echo '<p class="col-xs-12 left push-t" style="padding-bottom:10px">Other:</p>';
                ...
                <div id="fm7" class="tab fld chk-fld col-xs-10 center">                    
                    ...
                    <div class="info_wrap lrg col-xs-12 center inline left">    
                        ...
                        <div class="lrg col-xs-12 center inline left">
                            <?php
                                echo '<p class="col-xs-8 left inline">What vehicles are permitted on the property? E.g.: Automobiles, motorcycles, trailers, campers, boats, recreational vehicles, four-wheelers, dirt-bikes, go-carts, golf carts, etc.</p>';
                                echo '<div class="col-xs-3 fm_input fm_text inline center right last">';
                ...
                <div id="fm8" class="tab fld col-xs-10 center">                    
                    <div class="info_wrap lrg col-xs-12 center inline left">
                        ...
                        <div class="lrg col-xs-12 center inline left">
                            <?php                            
                                echo '<p class="col-xs-10 left inline">Can the Lease be terminated by the Landlord if the Property is sold?  If yes, then with how many days notice to Tenant?</p>';
                                echo '<div class="fm_input fm_text inline center right last">';
                            ...
                            <div id="div-provisions" class="col-xs-12 left">
                                    ...
                                    /*if (isset($autofill_custom_provisions['Provisions'])) {
                                        ...
                                        foreach ($autofill_custom_provisions['Provisions'] as $provision) { */
                                            ...
                                            echo ' <span id="provision-number' . $i . '" class="provision-number left col-xs-6"><p>';
                                            echo '<strong>Provision Number: </strong>', $i+1;
                                            echo '</p></span>';
                                            echo '<div class="col-xs-6 right inline push-b"><a href="#" onclick="removeProvision(' . $i . ');return false;" alt="Remove this Custom Provision" title="Remove this Custom Provision"><img src="/img/icon_trash.png" /></a></div>';
                        ...
                        <div id="pet-wrapper" class="lrg col-xs-12 center inline left">
                            <?php                         
                                echo $this->Form->input('how_many_pets', [
                                        'div' => array('class' => 'fm_input fm_text col-xs-2-2 left'),
                                        'id' => 'rentDueDate',
                                        'class' => 'input col-xs-12 center',
                                        'empty' => 'How Many Pets?',
                                        'after' => 'How Many Pets?',
                                ...
                                echo $this->Form->input('monthly_pet_fee', [
                                        'div' => array('class' => 'fm_input fm_text col-xs-2-2 center inline left'),
                                        'class' => 'input center inline right',
                                        'type' => 'text',
                                        'after' =>  'Monthly Pet Fee',
                                        'label' => false,
                                        'onkeypress' => 'return isNumber(event)'
                                    ]);
                                echo $this->Form->input('pet_fee', [
                                        ...
                                        'class' => 'input center inline right',
                                        'type' => 'text',
                                        'after' =>  'Non-Refundable Fee',
                                        'label' => false,
                                        'onkeypress' => 'return isNumber(event)'
                                    ]);
                                echo $this->Form->input('pet_deposit', [
                                        'div' => array('class' => 'fm_input fm_text col-xs-2-2 center inline left last'),
                                        'class' => 'input inline center right',
                                        'type' => 'text',
                                        'after' =>  'Additional Deposit',
                                        'label' => false,
                                        'onkeypress' => 'return isNumber(event)'
                                    ]);
