...
<div class="notices view">
  <h2>Detailed Notice Information</h2>
	<?php echo $this->Html->link($this->Html->image('/img/btn_my_notices.png'), array('controller' => 'notices', 'action' => 'index'), array('escape' => false)); ?>
	<br /><br />

	<!--dt><?php echo __('Last modification date'); ?></dt>
	<dd>
		<?php echo date('l, F jS Y', strtotime($notice['Notice']['modified'])); ?>
		&nbsp;
	</dd-->
